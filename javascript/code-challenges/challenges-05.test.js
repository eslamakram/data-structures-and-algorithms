...
const addValues = (arr) => {
  // Solution code here...
 let addedArray = arr.reduce(( total , itemValue) => {
...
const addPurchases = (arr) => {
  // Solution code here...
  let purchasePriceTotal = arr.reduce((acc,itemPrice) => {
    return acc+itemPrice.purchasePrice;
  },0);
...
const countNumberOfElements = (arr) => {
  ...
  let countElements = arr.reduce((counter)=>{
...
const reversedString = (str) => {
  // Solution code here...
 let reverseString = str.split('').reduce((acc, val)=>{
    return val+acc;
  });
