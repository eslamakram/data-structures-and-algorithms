...
const containsW = (str) => {
  // Solution code here...
  const checkLetterW=/w/g;
  return checkLetterW.test(str);
};
...
Write a function named containsWorld that takes in a string 
or number of any length. This function should use a regular expression pattern 
to return true if the input contains the word 'world' all in lower-case letters, and false if the input does not.

------------------------------------------------------------------------------------------------ */

const containsWorld = (input) => {
  // Solution code here...
  const checkWorld=/world/g;
...
const isCapitalized = (str) => {
  // Solution code here...
  const checkCap = /\b[A-Z]\w*/g;
  return str.match(checkCap) || [];
};
...
const citiesAtoJ = (arr) => {
  // Solution code here...
  const checkCities =/^[A-J]/g;
  let newArray=arr.filter(element=>{
    return element.match(checkCities);
  });
  return newArray;
};
